...
CREATE TABLE TESTRUN (
  ...
  Hidden int(11),
  FOREIGN KEY(System_ID) REFERENCES SYSTEMS(ID),
  FOREIGN KEY(TestRun_Manager_ID) REFERENCES TESTRUN_MANAGER(ID),
  PRIMARY KEY (ID),  
  date_modified TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP
);
...
CREATE TABLE INVENTORY_ATTRIBUTES (
  ID int(11) NOT NULL AUTO_INCREMENT,
  Target_ID int(11) NOT NULL,
  Available_Attributes_ID int(11) NOT NULL,
  Attribute_Value varchar(1000),
  PRIMARY KEY (ID),
  FOREIGN KEY(Target_ID) REFERENCES TARGETS(ID),
  FOREIGN KEY(Available_Attributes_ID) REFERENCES  AVAILABLE_ATTRIBUTES(ID),
  date_modified TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP
);
